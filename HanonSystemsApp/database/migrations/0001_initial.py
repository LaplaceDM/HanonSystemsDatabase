    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "test_screening_result",
                    models.CharField(max_length=4, null=True, verbose_name="Test Screening Result"),
                ),
                (
                    "harness_connector_condition",
                    models.CharField(max_length=4, null=True, verbose_name="Harness Connector Condition"),
                ),
                (
                    "insulation_condition",
                    models.CharField(max_length=4, null=True, verbose_name="Insulation Condition"),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                db_column="test_map_id",
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                to="database.testmap",
                verbose_name="Test Map",
            ),
        ),
        migrations.AddField(
            model_name="test",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "subcomponent_id",
                    models.BigAutoField(primary_key=True, serialize=False, verbose_name="Subcomponent"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "dar",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.SET_NULL, to="database.dar", verbose_name="DAR"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("id", models.AutoField(primary_key=True, serialize=False)),
                (
                    "pretest_inspection_and_photo",
                    models.CharField(max_length=10, null=True, verbose_name="Pretest Inspection and Photo"),
                ),
                ...
                (
                    "system_restriction_record",
                    models.CharField(max_length=10, null=True, verbose_name="System Restriction Record"),
                ),
                (
                    "trial_run_record_and_process",
                    models.CharField(max_length=10, null=True, verbose_name="Trial Run Record And Process"),
                ),
        ...
        migrations.AddField(
            ...
            name="lab_id",
            field=models.ForeignKey(
                db_column="lab_id", null=True, on_delete=django.db.models.deletion.SET_NULL, to="database.lab"
            ),
        ),
    ]
