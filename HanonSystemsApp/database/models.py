...
class Product(models.Model):
    ...
    program_id = models.ForeignKey(
        "Program", on_delete=models.CASCADE, null=True, db_column="program_id", verbose_name="Program"
    )
...
class Technician_Skill(models.Model):
    ...
    technician_id = models.ForeignKey(
        "Technician", on_delete=models.CASCADE, db_column="technician_id", verbose_name="Technician name"
    )
...
class DUT(models.Model):
    ...
    product_id = models.ForeignKey(
        "Product", on_delete=models.SET_NULL, null=True, db_column="product_id", verbose_name="Product"
    )
...
class Test_Harness(models.Model):
    ...
    date_removed = models.DateTimeField(null=True)
    test_id = models.ForeignKey("Test", on_delete=models.CASCADE, db_column="test_id", verbose_name="Test")
    harness_id = models.ForeignKey(
        "Harness", on_delete=models.CASCADE, db_column="harness_id", verbose_name="Harness name"
    )
...
class Test(models.Model):
    ...
    program_id = models.ForeignKey(
        "Program", on_delete=models.CASCADE, db_column="program_id", verbose_name="Program", null=True
    )
    product_id = models.ForeignKey(
        "Product", on_delete=models.CASCADE, db_column="product_id", verbose_name="Product", null=True
    )
    test_map_id = models.ForeignKey(
        "TestMap", on_delete=models.CASCADE, db_column="test_map_id", verbose_name="Test Map", null=True
    )
    ...
    test_type_id = models.ForeignKey(
        "TestType", on_delete=models.CASCADE, db_column="test_type_id", verbose_name="Test Type"
    )
    test_description = models.TextField(max_length=150)
    test_id = models.AutoField(primary_key=True)
    technician_id = models.ForeignKey(
        "Technician", on_delete=models.CASCADE, db_column="technician_id", verbose_name="Technician", null=True
    )
    chamber_id = models.ForeignKey(
        "Chamber", on_delete=models.CASCADE, db_column="chamber_id", verbose_name="Chamber", null=True
    )
    dar_id = models.ForeignKey("DAR", on_delete=models.CASCADE, db_column="dar_id", verbose_name="DAR", null=True)
    cage_id = models.ForeignKey("Cage", on_delete=models.CASCADE, db_column="cage_id", verbose_name="Cage", null=True)
    lab_id = models.ForeignKey("Lab", on_delete=models.CASCADE, db_column="lab_id", verbose_name="Lab", null=True)
...
class ChamberLogInfo(models.Model):
    created = models.DateTimeField(default=timezone.now)
    id = models.AutoField(primary_key=True)
    pretest_inspection_and_photo = models.CharField(
        max_length=10, verbose_name="Pretest Inspection and Photo", null=True
    )
    ...
    trial_run_record_and_process = models.CharField(
        max_length=10, verbose_name="Trial Run Record And Process", null=True
    )
    ...
    chamber_id = models.ForeignKey(
        "Chamber", on_delete=models.SET_NULL, null=True, db_column="chamber_id", verbose_name="Chamber"
    )
    program_id = models.ForeignKey(
        "Program", on_delete=models.SET_NULL, null=True, db_column="program_id", verbose_name="Program"
    )
    technician_id = models.ForeignKey(
        "Technician", on_delete=models.SET_NULL, null=True, db_column="technician_id", verbose_name="Technician"
    )
...
class Test_Chamber(models.Model):
    ...
    test_type_id = models.ForeignKey(
        "TestType", on_delete=models.CASCADE, null=True, db_column="test_type_id", verbose_name="Test"
    )

    chamber_id = models.ForeignKey(
        "Chamber", on_delete=models.CASCADE, null=True, db_column="chamber_id", verbose_name="Chamber"
    )
...
class Program_Fluid(models.Model):
    ...
    fluid_id = models.ForeignKey(
        "Fluid", on_delete=models.CASCADE, null=True, db_column="fluid_id", verbose_name="Fluid"
    )
