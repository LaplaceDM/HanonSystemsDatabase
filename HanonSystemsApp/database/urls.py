...
urlpatterns = [
    ...
    path(
        "Test_Harness/update_Test_Harness/<int:pk>",
        views.UpdateTableViewTest_Harness.as_view(),
        name="update_Test_Harness",
    ),
    ...
    path(
        "Technician_Skill/delete_Technician_Skill/<int:pk>",
        views.delete_Technician_Skill,
        name="delete_Technician_Skill",
    ),
    path(
        "Technician_Skill/update_Technician_Skill/<int:pk>",
        views.UpdateTableViewTechnician_Skill.as_view(),
        name="update_Technician_Skill",
    ),
    ...
    path(
        "Test_Chamber/update_Test_Chamber/<int:pk>",
        views.UpdateTableViewTest_Chamber.as_view(),
        name="update_Test_Chamber",
    ),
    ...
    path(
        "Program_Cage/update_Program_Cage/<int:pk>",
        views.UpdateTableViewProgram_Cage.as_view(),
        name="update_Program_Cage",
    ),
    ...
    path(
        "Program_DAR/update_Program_DAR/<int:pk>", views.UpdateTableViewProgram_DAR.as_view(), name="update_Program_DAR"
    ),
    ...
    path(
        "Program_Fluid/update_Program_Fluid/<int:pk>",
        views.UpdateTableViewProgram_Fluid.as_view(),
        name="update_Program_Fluid",
    ),
    ...
    path(
        "ChamberLogInfo/delete_ChamberLogInfo/<int:pk>", views.delete_item_ChamberLogInfo, name="delete_ChamberLogInfo"
    ),
    path(
        "ChamberLogInfo/update_ChamberLogInfo/<int:pk>",
        views.UpdateTableViewChamberLogInfo.as_view(),
        name="update_ChamberLogInfo",
    ),
    ...
    # path('ChamberLog/update_ChamberLog/<int:pk>',
    #      views.UpdateTableViewChamberLog.as_view(),
    #      name="update_ChamberLog"),
    ...
    path(
        "subcomponent/update_subcomponent/<int:pk>",
        views.UpdateTableViewSubcomponent.as_view(),
        name="update_subcomponent",
    ),
    ...
    path(
        "dar_channel/update_dar_channel/<int:pk>",
        views.UpdateTableView_DAR_Channel.as_view(),
        name="update_DAR_Channel",
    ),
